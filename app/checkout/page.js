  ...
  return (
    <section className="mx-auto px-6 lg:px-28 xl:px-40 max-w-[66.5rem]">
      ...
      <div
        ...
        className="cursor-pointer mt-10 h-14 bg-black flex gap-6 justify-center items-center hover:scale-105 hover:transition-all"
      >
      ...
      <Modal isOpen={isModalOpen} onClose={handleCloseModal}>
        <div className="mx-auto py-4">
          <div className="flex flex-col items-center gap-5 text-lg">
            ...
            <h3>Your payment was success</h3>
