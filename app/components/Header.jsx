      ...
      <nav className="flex justify-between items-center w-full h-[104px] px-6 text-white bg-white md:bg-[#948775] sticky">
        ...
        >
          {navOpen ? (
            ...
            <Image src={MenuIcon} alt="menu" unoptimized />
          )}
        </div>
        ...
        <ul className="hidden md:flex text-white">
          {links.map(({ id, link }) => (
            <li
              key={id}
              className="nav-links px-4 cursor-pointer font-medium hover:scale-105 hover:text-white duration-200 link-underline"
            >
        ...
        <div className="flex md:hidden gap-3">
          ...
          <Image alt="bag" src={Bag} className="text-white" />
        </div>
